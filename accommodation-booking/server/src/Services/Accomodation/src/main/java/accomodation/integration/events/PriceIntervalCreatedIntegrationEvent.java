...
public class PriceIntervalCreatedIntegrationEvent extends IntegrationEvent {
    ...
    public PriceIntervalCreatedIntegrationEvent(UUID priceIntervalId, UUID accommodationId, float amount, LocalDateTime start, LocalDateTime end) {
        super();
